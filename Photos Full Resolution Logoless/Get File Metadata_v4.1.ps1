...
try {
    ...
    $folderPath = "C:\Users\Brend\Documents\Database Project Repository\Database-Project\Photos Full Resolution Logoless"
...
$outputCsv = Join-Path (Get-Location).Path "photo_metadata.csv"
